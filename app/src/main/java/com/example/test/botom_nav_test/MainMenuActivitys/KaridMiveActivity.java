...
public class KaridMiveActivity extends AppCompatActivity implements ExampleAdapter_Ryv.onItemClickListener/*, ExampleAdapter_ProRyv.OnItemClickListenerPro*/ {
    ...
    public ArrayList<ExampleItem_model> mExampleList;//آرایه ای که لیست مواردcat RYV را در خود نگه میدارد.
    public ArrayList<ExampleItem_ProModel> mExampleList_Pro;//آرایه ای که لیست مواردpro RYV را در خود نگه میدارد.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karid_mive);
    ...
    private void setUpViews() {
        dialog_load = new Dialog(KaridMiveActivity.this);

        ryscrview_category = (RecyclerView) findViewById(R.id.ryscrview_category);
        ryscrview_category.setLayoutManager(new LinearLayoutManager(KaridMiveActivity.this));

        ryscrview_product = (RecyclerView) findViewById(R.id.ryscrview_product);
        ryscrview_product.setLayoutManager(new LinearLayoutManager(KaridMiveActivity.this));
    ...
    private void onCreateEvents() {
        dialog_load = new Dialog(KaridMiveActivity.this);
        final View itemView = LayoutInflater.from(KaridMiveActivity.this).inflate(R.layout.sefareshgozari_loading, null);
        ...
        btn_goto_homeactivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KaridMiveActivity.this, MainActivity.class);
        ...
        btn_takmil_karid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KaridMiveActivity.this, SefareshBasket.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void getAllCategorys() {
        ...
        final JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, recy_cat_api_url, null, new Response.Listener<JSONArray>() {
                ...
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        if (ID == 20114) {
                            ...
                            Log.i("must_egnor", "egnored ids");
                        }
                    }

                    /*int $id_prem = category.getId();
                    String Name_prem = category.getName();
                    int ID_prem = category.getID();
                    ...
                    mExampleAdapter_Ryv = new ExampleAdapter_Ryv(KaridMiveActivity.this, mExampleList);
                    ryscrview_category.setAdapter(mExampleAdapter_Ryv);
                    mExampleAdapter_Ryv.setOnItemClickListener(KaridMiveActivity.this);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(KaridMiveActivity.this, "Error in connection", Toast.LENGTH_SHORT).show();
                Toast.makeText(KaridMiveActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        mExampleList_Pro.add(new ExampleItem_ProModel(exampleModel_pro.get$id(), exampleModel_pro.getProductName(), exampleModel_pro.getProDesc(), exampleModel_pro.getSupplier(), exampleModel_pro.getProID(), exampleModel_pro.getPrice(), exampleModel_pro.getImage()));
